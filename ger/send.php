...
<html>
<head>
<title>Almanca Site İletişim Formu</title>
</head>
<body>
...
';
	...
	$mail->CharSet = 'UTF-8';
	$mail->Subject = 'Almanca Site İletişim Formu';
	$mail->MsgHTML($mailContent);
	
	if($mail->send()){
		$_SESSION['title'] = "E-Mail gesendet";
		$_SESSION['status'] = "Unsere Teammitglieder werden Sie so schnell wie möglich anrufen.";
		$_SESSION['icon'] = "success";
		header("Location:$page");
	}else{
		$_SESSION['title'] = "Fehler!";
		$_SESSION['status'] = "Ein Problem ist aufgetreten. Bitte versuchen Sie es später erneut.";
		$_SESSION['icon'] = "error";
		header("Location:$page");
}
