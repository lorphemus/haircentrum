        ...
        <div class="all__sidebar-item">
            ...
            <div class="all__sidebar-item-category">
                <ul>                                    
                    ...
                    ?>
                    <li><a href="<?php echo $base_link; ?>fr/services/<?=seo($service["service_title_fr"]).'/'.$service["id"]?>"><?php echo $service["service_title_fr"]; ?><i class="far fa-angle-double-right"></i></a></li>
                    <?php } ?>
                </ul>
            </div>
        </div>
        <div class="all__sidebar-item-help mt-30" data-background="<?php echo $base_link.select("aside_settings", "pic_url", 0); ?>">
            <h3><?php echo select("aside_settings", "up_title_fr", 0); ?></h3>
            <div class="all__sidebar-item-help-contact">
                ...
                <div class="all__sidebar-item-help-contact-content">
                    <span><?php echo select("aside_settings", "title_fr", 0); ?></span>
