        ...
        <div class="row align-items-center">
            <div class="col-xl-7 col-md-5">
                <div class="subscribe__area-title">
                    <h3><?php echo select("newsletter_settings", "nl_title_ger", 0); ?></h3>
                </div>
            </div>
            <div class="col-xl-5 col-md-7">
                <div class="subscribe__area-subscribe">
                    <form action="#">
                        <input type="text" name="email" placeholder="Abonnieren" required="">
                        <button class="theme-btn" type="submit"><?php echo select("newsletter_settings", "btn_title_ger", 0); ?></button>
                    </form>
                </div>
            </div>
        </div>
...
<div class="floating_btn">
    <a target="_blank" href="https://wa.me/<?php echo select("contact_settings", "whatsapp", 0); ?>?text=Ich%20möchte%20Informationen%20über%20Ihre%20Dienstleistungen%20erhalten">
        ...
        <div class="row">
            <div class="col-xl-4 col-lg-4 col-sm-6 lg-mb-30">
                <div class="footer__area-widget borders">
                    ...
                    <div class="footer__area-widget-about">
                        <p><?php echo select("seo_setup", "short_about_ger", 0); ?></p>
                ...
                <div class="footer__area-widget borders">
                    ...
                    <div class="footer__area-widget-contact">
                        <ul>
                            ...
                            ?>
                            <li><a href="<?php echo $base_link; ?>ger/services/<?=seo($service["service_title_ger"]).'/'.$service["id"]?>"><?php echo $service["service_title_ger"]; ?></a></li>
                            <?php } ?>
                        </ul>
                    </div>
                </div>
            ...
            <div class="col-xl-4 col-lg-4 col-sm-6 sm-mb-30">
                <div class="footer__area-widget borders border-r">
                    ...
                    <div class="footer__area-widget-contact">
                        <ul>
                            <li><a href="<?php echo $base_link; ?>ger/contact.php"><?php echo select("contact_settings", "address", 0); ?></a></li>
