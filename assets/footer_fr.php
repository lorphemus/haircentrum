        ...
        <div class="row align-items-center">
            <div class="col-xl-7 col-md-5">
                <div class="subscribe__area-title">
                    <h3><?php echo select("newsletter_settings", "nl_title_fr", 0); ?></h3>
                </div>
            </div>
            <div class="col-xl-5 col-md-7">
                <div class="subscribe__area-subscribe">
                    <form action="#">
                        <input type="text" name="email" placeholder="S'abonner" required="">
                        <button class="theme-btn" type="submit"><?php echo select("newsletter_settings", "btn_title_fr", 0); ?></button>
                    </form>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-xl-4 col-lg-4 col-sm-6 sm-mb-30">
                <div class="footer__area-widget borders border-r">
                    ...
                    <div class="footer__area-widget-contact">
                        <ul>
                            <li><a href="<?php echo $base_link; ?>fr/contact.php"><?php echo select("contact_settings", "address", 0); ?></a></li>
