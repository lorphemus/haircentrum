...
<head>
    ...
    <title><?php echo select("seo_setup", "title_en", 0); ?> | Contact</title>
            ...
            <div class="row mb-60">
                <div class="col-xl-12">
                    <div class="contact__page-title t-center">
						<span class="subtitle"><?php echo select("form", "up_title_en", 0); ?></span>
						<h2><?php echo select("form", "main_title_en", 0); ?></h2>	
                    </div>                    
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="contact__page-form">
                        <h2>Stay in Touch</h2>
                        <form action="<?php echo $base_link; ?>en/send.php" method="post">	
                            <div class="row">
                                ...
                                <div class="col-md-6 md-mb-30"> 
                                    <div class="contact__page-form-item">
                                        <input type="text" name="service" placeholder="Service you want" required="required">
                                    </div>										
                                </div>
                                ...
                                <div class="col-lg-12">										
                                    <div class="contact__page-form-item">
                                        ...
                                        <button class="theme-btn" type="submit" name="send_mail">Send</button>
                                    </div>										
                                </div>
                            </div>							
                        </form>
