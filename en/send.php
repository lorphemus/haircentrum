...
<html>
<head>
<title>İngilizce Site İletişim Formu</title>
</head>
<body>
...
';
	...
	$mail->CharSet = 'UTF-8';
	$mail->Subject = 'İngilizce Site İletişim Formu';
	$mail->MsgHTML($mailContent);
	
	if($mail->send()){
		$_SESSION['title'] = "Mail Sent";
		$_SESSION['status'] = "Our team members will call you as soon as possible.";
		$_SESSION['icon'] = "success";
		header("Location:$page");
	}else{
		$_SESSION['title'] = "Error!";
		$_SESSION['status'] = "A problem occured. Please try again later.";
		$_SESSION['icon'] = "error";
		header("Location:$page");
}
