...
<head>
    ...
    <title><?php echo select("seo_setup", "title_en", 0); ?> | <?php echo select("services", "service_title_en", $_GET["id"]); ?></title>
...
<body>
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="page__banner-title">
                        <h1><?php echo select("services", "service_title_en", $_GET["id"]); ?></h1>
                        <div class="page__banner-title-menu">
                            <ul>
                                <li><a href="<?php echo $base_link; ?>en/index.php">Home</a></li>
                                <li><span> | </span><?php echo select("services", "service_title_en", $_GET["id"]); ?></li>
                            </ul>
                        </div>
                    </div>
                </div>
    ...
    <div class="services__details section-padding">
        <div class="container">
            <div class="row">
                <?php include("../assets/aside_en.php"); ?>
                <div class="col-xl-8 col-lg-8">
                    <div class="services__details-content">
						<?php echo select("services", "service_text_en", $_GET["id"]); ?>
                    </div>
                </div>
            </div>
        </div>
