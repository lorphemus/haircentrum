...
if(isset($_POST['repass'])){
	...
	if($remail){
		...
		if($count==1){
            ...
            $mail->Password = 'Uz9sdzyv'; //paste one generated by Mailtrap
            $mail->Port = 587;
            $mail->From     = "no-reply@haircentrum.com";
            $mail->CharSet = 'UTF-8';
            ...
            $mail->Body = '<html>
                        ...
                        <body>
							<img src="http://www.haircentrum.com/assets/img/logo.png" alt="logo">
                            ...
                            <p><a href="http://www.haircentrum.com/admin/newpass.php?renewpass=true&token='.$token_code.'">Şifreyi Sıfırla</a></p>
                        </body>
                        </html>';
