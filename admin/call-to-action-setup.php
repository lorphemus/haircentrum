  ...
  <div class="content-wrapper">
    ...
    <section class="content">
	    <div class="box">
		    <div class="box-body">
				<?php 
				$query=$db->prepare("SELECT * FROM casetup WHERE id=?");
				...
				<form action="assets/process.php" method="POST" enctype="multipart/form-data">
					...
					<div class="form-group">
						<label>Arka Resim</label>
						<br>
						<img src="../<?php echo $get_data["pic_url"]; ?>" width="800px";>
					</div>
					<div class="form-group">
						<input type="file" name="ca_pic" value="<?php echo $get_data["pic_url"]; ?>">
					</div>
					<div class="form-group">
						<input type="hidden" name="unlink" value="<?php echo $get_data["pic_url"]; ?>">
						<button type="submit" class="btn btn-success" name="update_ca_pic"><i class="fa fa-refresh"></i> Resmi Güncelle</button>
					</div
				</form>
				...
				<form action="assets/process.php" method="post">
					...
					<button type="submit" name="ca_update" class="btn btn-success"><i class="fa fa-refresh"></i> Güncelle</button>
				</form>
				...
				<form action="assets/process.php" method="post">
					...
					<div class="nav-tabs-custom">
						...
						<div class="tab-pane active" id="tab_6">
							<input type="text" class="form-control" name="link_text_tr" value="<?php echo $get_data["link_text_tr"]; ?>" required>
						</div>
						<!-- /.tab-pane -->
						<div class="tab-pane" id="tab_7">
							<input type="text" class="form-control" name="link_text_en" value="<?php echo $get_data["link_text_en"]; ?>" required>
						</div>
						<!-- /.tab-pane -->
						<div class="tab-pane" id="tab_8">
							<input type="text" class="form-control" name="link_text_ger" value="<?php echo $get_data["link_text_ger"]; ?>" required>
						</div>
						<!-- /.tab-pane -->
						<div class="tab-pane" id="tab_9">
							<input type="text" class="form-control" name="link_text_fr" value="<?php echo $get_data["link_text_fr"]; ?>" required>
						</div>
						<!-- /.tab-pane -->
						<div class="tab-pane" id="tab_10">
							<input style="direction: rtl;" type="text" class="form-control" name="link_text_ar" value="<?php echo $get_data["link_text_ar"]; ?>" required>
						</div>
						<!-- /.tab-pane -->
						</div>
						<!-- /.tab-content -->
					...
					<button type="submit" name="ca_link_update" class="btn btn-success"><i class="fa fa-refresh"></i> Güncelle</button>
				</form>
		    </div>
	    </div>
		<?php
