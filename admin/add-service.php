      ...
      <div class="box">
        <div class="box-body">
			<form action="assets/process.php" method="post" enctype="multipart/form-data">
				  ...
				  <div class="nav-tabs-custom">
					...
					<div class="tab-content">
					  <div class="tab-pane active" id="tab_1">
						<input type="text" class="form-control" name="service_title_tr" placeholder="Türkçe Hizmet Başlığını Girin" required>
					  </div>
					  <!-- /.tab-pane -->
					  <div class="tab-pane" id="tab_2">
						<input type="text" class="form-control" name="service_title_en" placeholder="İngilizce Hizmet Başlığını Girin" required>
					  </div>
					  <!-- /.tab-pane -->
					  <div class="tab-pane" id="tab_3">
						<input type="text" class="form-control" name="service_title_ger" placeholder="Almanca Hizmet Başlığını Girin" required>
					  </div>
					  <!-- /.tab-pane -->
					  <div class="tab-pane" id="tab_4">
						<input type="text" class="form-control" name="service_title_fr" placeholder="Fransızca Hizmet Başlığını Girin" required>
					  </div>
					  <!-- /.tab-pane -->
					  <div class="tab-pane" id="tab_5">
						<input style="direction: rtl;" type="text" class="form-control" name="service_title_ar" placeholder="Arapça Hizmet Başlığını Girin" required>
					  </div>
					  <!-- /.tab-pane -->
					</div>
					<!-- /.tab-content -->
				  ...
				  <div class="nav-tabs-custom">
					...
					<div class="tab-content">
					  <div class="tab-pane active" id="tab_6">
						<textarea name="service_text_tr" id="editor1" rows="10" cols="80" required></textarea>
					  </div>
					  <!-- /.tab-pane -->
					  <div class="tab-pane" id="tab_7">
						<textarea name="service_text_en" id="editor2" rows="10" cols="80" required></textarea>
					  </div>
					  <!-- /.tab-pane -->
					  <div class="tab-pane" id="tab_8">
						<textarea name="service_text_ger" id="editor3" rows="10" cols="80" required></textarea>
					  </div>
					  <!-- /.tab-pane -->
					  <div class="tab-pane" id="tab_9">
						<textarea name="service_text_fr" id="editor4" rows="10" cols="80" required></textarea>
					  </div>
					  <!-- /.tab-pane -->
					  <div class="tab-pane" id="tab_10">
						<textarea name="service_text_ar" id="editor5" rows="10" cols="80" required></textarea>
					  </div>
					  <!-- /.tab-pane -->
					</div>
					<!-- /.tab-content -->
				...
				<button type="submit" name="add_service" class="btn btn-success"><i class="fa fa-plus"></i> Yeni Hizmet Ekle</button>
			</form>
		</div>
		<!-- /.box-body -->
