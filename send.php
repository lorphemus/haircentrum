...
<html>
<head>
<title>Türkçe Site İletişim Formu</title>
</head>
<body>
...
';
	...
	$mail->CharSet = 'UTF-8';
	$mail->Subject = 'Türkçe Site İletişim Formu';
	$mail->MsgHTML($mailContent);
	
	if($mail->send()){
		$_SESSION['title'] = "Mail Gönderdildi";
		$_SESSION['status'] = "Ekip arkadaşlarımız en kısa sürede sizi arayacak.";
		$_SESSION['icon'] = "success";
		header("Location:$page");
	}else{
		$_SESSION['title'] = "Hata!";
		$_SESSION['status'] = "Bir sorun oldu. Lütfen daha sonra tekrar deneyin.";
		$_SESSION['icon'] = "error";
		header("Location:$page");
}
