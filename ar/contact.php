...
<head>
    ...
    <title><?php echo select("seo_setup", "title_ar", 0); ?> | Contact</title>
...
<body>
    ...
    <div class="contact__page section-padding pb-0">
        <div class="container">
            <div class="row mb-60">
                <div class="col-xl-12">
                    <div class="contact__page-title t-center" style="direction: rtl;">
						<span class="subtitle"><?php echo select("form", "up_title_ar", 0); ?></span>
						<h2><?php echo select("form", "main_title_ar", 0); ?></h2>	
                    </div>                    
                </div>
            </div>
            <div class="row section-padding pt-0"  style="direction: rtl;">
                <div class="col-xl-4 col-lg-6 xl-mb-30">
                    <div class="contact__page-item">
                        ...
                        <div class="contact__page-item-content">
                            <h5>الهاتف</h5>
                            <p style="direction: ltr;"><a href="tel:<?php echo select("contact_settings", "phone", 0); ?>"><?php echo select("contact_settings", "phone", 0); ?></a></p>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="contact__page-form"  style="direction: rtl;">
                        <h2> اتصل بنا الآن</h2>
                        <form action="<?php echo $base_link; ?>ar/send.php" method="post">	
                            <div class="row">
                                <div class="col-md-6 mb-30"> 
                                    <div class="contact__page-form-item">
                                        <input type="text" name="name" placeholder="اسمك الأول والأخير" required="required">
                                    </div>										
                                </div>
                                ...
                                <div class="col-md-6 mb-30"> 
                                    <div class="contact__page-form-item">
                                        <input type="text" name="phone" placeholder="رقم هاتفك" required="required">
                                    </div>										
                                </div>
                                <div class="col-md-6 md-mb-30"> 
                                    <div class="contact__page-form-item">
                                        <input type="text" name="service" placeholder="الخدمة التي تريد الحصول عليها" required="required">
                                    </div>										
                                </div>
                                ...
                                <div class="col-lg-12">										
                                    <div class="contact__page-form-item">
                                        ...
                                        <button class="theme-btn" type="submit" name="send_mail">إرسال</button>
                                    </div>										
                                </div>
                            </div>							
                        </form>
