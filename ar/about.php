...
<head>
    ...
    <title><?php echo select("seo_setup", "title_ar", 0); ?> | About Us</title>
...
<body>
            ...
            <div class="row">
                <div class="col-xl-12 col-lg-12" style="direction: rtl;">
                    <div class="mission__area-title">
						<span class="subtitle"><?php echo select("about", "up_title_ar", 0); ?></span>
						<h2><?php echo select("about", "main_title_ar", 0); ?></h2>	
                        <p><?php echo select("about", "text_ar", 0); ?></p>                        
                    </div>
                </div>
            </div>
        </div>
			...
			<div class="row">
				<div class="col-xl-12">
					<div class="appointment__area-title">
						<h2><?php echo select("casetup", "title_ar", 0); ?></h2>
						<a href="<?php echo $base_link; ?>ar/contact.php" class="theme-btn"><?php echo select("casetup", "link_text_ar", 0); ?></a>
					</div>
				</div>
			</div>
		</div>
	...
	<div class="working__process section-padding pt-5" style="direction: rtl;">
		<div class="container">
			<div class="row mb-60">
				<div class="col-xl-12">
					<div class="working__process-title t-center">
						<span class="subtitle"><?php echo select("otherserv", "up_title_ar", 0); ?></span>
						<h2><?php echo select("otherserv", "main_title_ar", 0); ?></h2>
					</div>					
				</div>
			</div>
			<div class="row">
				<div class="col-xl-4 col-lg-4 col-md-6 lg-mb-30">
					<div class="working__process-item">
						...
						<div class="working__process-item-content">
							<h5><?php echo select("otherserv", "box1_title_ar", 0); ?></h5>
							<p><?php echo select("otherserv", "box1_text_ar", 0); ?></p>
						</div>
					</div>
				</div>
				<div class="col-xl-4 col-lg-4 col-md-6 md-mb-30">
					<div class="working__process-item">
						...
						<div class="working__process-item-content">
							<h5><?php echo select("otherserv", "box2_title_ar", 0); ?></h5>
							<p><?php echo select("otherserv", "box2_text_ar", 0); ?></p>
						</div>
					</div>
				</div>
				<div class="col-xl-4 col-lg-4 col-md-6">
					<div class="working__process-item">
						...
						<div class="working__process-item-content">
							<h5><?php echo select("otherserv", "box3_title_ar", 0); ?></h5>
							<p><?php echo select("otherserv", "box3_text_ar", 0); ?></p>
						</div>
					</div>
				</div>
			</div>
